...
class Blockchain(object):
    ...
    def proof_of_work(self, last_proof):
        ...
        - Find a number p' such that hash(pp') contains 4 leading 0s, where
          p is the previous p'
    ...
    def register_nodes(self, address):
        ...
        :param address: <str> Address of new node, eg. 'http://192.168.0.5:5000'
        :return: None
        """
    ...
    def resolve_conflicts(self):
        ...
        our chain with the longest chain in the network.
...
def mine():
    ...
    # The sender is 0 to signify that that this node has mined a new coin.
...
def new_transaction():
    ...
    # Chec that the required fields are in the POSTed data
